...
import com.example.mymathe.Results.ResultSubtract;
import com.example.mymathe.levels.GameLevels;
import com.example.mymathe.levels.GameLevelsSubtract;

import java.util.Random;

public class LevelTrueFalseSubtract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExitMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Intent intent = new Intent(LevelTrueFalseSubtract.this, GameLevelsSubtract.class);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(LevelTrueFalseSubtract.this, LevelTrueFalseSubtract.class);
                    startActivity(intent);
                    finish();
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
