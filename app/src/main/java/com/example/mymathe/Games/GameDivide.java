...
public class GameDivide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.unnameddiv);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userLife <= 0)
                {
                    ...
                    Intent intent = new Intent(GameDivide.this, ResultDivide.class);
    ...
    public void onBackPressed(){
        if(backPressedTime + 2000 > System.currentTimeMillis()){
            backToast.cancel();
            Intent intent = new Intent(GameDivide.this, GameLevelsDivide.class);
            startActivity(intent);
            finish();
            return;
        }else{
