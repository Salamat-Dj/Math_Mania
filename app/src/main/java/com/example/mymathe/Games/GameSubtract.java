...
public class GameSubtract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.unnamedsub);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userLife <= 0)
                {
                    ...
                    Intent intent = new Intent(GameSubtract.this, ResultSubtract.class);
    ...
    public void onBackPressed(){
        if(backPressedTime + 2000 > System.currentTimeMillis()){
            backToast.cancel();
            Intent intent = new Intent(GameSubtract.this, GameLevelsSubtract.class);
            startActivity(intent);
            finish();
            return;
        }else{
